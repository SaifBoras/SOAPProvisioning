 ...
 *         &lt;element name="operation" type="{http://schemas.ericsson.com/cai3g1.2/}NotificationOperationType" maxOccurs="unbounded" minOccurs="0"/>
...
public class NotificationFilterType {
    ...
    protected List<NotificationOperationType> operation;
     ...
     * 
     */
    public List<NotificationOperationType> getOperation() {
        if (operation == null) {
            operation = new ArrayList<NotificationOperationType>();
        }
